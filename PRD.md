...
| Caso | Título                    | Dificuldade | Evidências | Testemunhas | Status    |

| ---- | ------------------------- | ----------- | ---------: | ----------: | --------- |

| 01   | O Desvio                  | ★★          |          4 |           0 | Publicado |

| 02   | Passageiros vs. Pedestres | ★★★         |          5 |           1 | Publicado |

| 03   | Quem é Responsável?       | ★★★★        |          5 |           1 | Rascunho  |

| 04   | Informação Imperfeita     | ★★★★        |          4 |           1 | Publicado |

| 05   | A Decisão Impossível      | ★★★★★       |          8 |           2 | Publicado |
